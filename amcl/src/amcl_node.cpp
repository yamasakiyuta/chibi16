                      ...
                      const ros::Time& t, const std::string& f)
{
  ...
  ////2016.02.18
  x = roomba_odometry_in.pose.pose.position.x;
  y = roomba_odometry_in.pose.pose.position.y;
 
  tf::Quaternion q(roomba_odometry_in.pose.pose.orientation.x, roomba_odometry_in.pose.pose.orientation.y, roomba_odometry_in.pose.pose.orientation.z, roomba_odometry_in.pose.pose.orientation.w);
      tf::Matrix3x3 m(q);
      double roll, pitch;
